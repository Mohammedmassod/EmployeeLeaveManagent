    ...
    public class LeaveRequestController : Controller
    {
        ...
        public ActionResult Create(CreateLeaveRequestVM model)
        {
            try
            {
                ...
                {
                    ModelState.AddModelError("", "ليس لديك أيام كافية لهذا الطلب!");
                    return View(model);
                }
                ...
                if (!isSuccess)
                {
                    ModelState.AddModelError("", "حدث خطأ ما أثناء إرسال السجل الخاص بك");
                    return View(model);
                }
            ...
            {
                ModelState.AddModelError("", "هناك خطأ ما");
                return View(model);
            }
        }
